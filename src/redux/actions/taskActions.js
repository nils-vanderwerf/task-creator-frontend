...
export const getAllTasks = () => dispatch => {
  ...
  fetch(`http://task-creator-app.herokuapp.com/users/${localStorage.getItem('user_id')}/tasks`, config)
    .then(r => r.json())
    .then(tasks => {
...
const updateTaskToDB = task => dispatch => {
  ...
  fetch(`http://task-creator-app.herokuapp.com/users/${localStorage.getItem('user_id')}/tasks/${task.task.id}`, config)
    .then(result => result.json())
...
const deleteTaskFromDB = ({ task }) => dispatch => {
  ...
  fetch(`http://task-creator-app.herokuapp.com/users/${localStorage.getItem('user_id')}/tasks/${task.id}`, config)
    .then(result => result.json())
    .then(() => {
